...
# Build all required binaries from the unified workspace root.
# Since all packages are part of the same workspace, they share the single
# dependency layout, compiled libraries, and Cargo.lock, avoiding recompilations.
