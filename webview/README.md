...
- Publish child traversable viewport dimensions from the visible placeholder bounds in root device pixels; reusing the stale child frame size leaves cross-origin iframe scenes permanently compositor-scaled after slot resizes.
