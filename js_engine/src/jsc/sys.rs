...
unsafe extern "C" {
    ...
    pub fn JSValueIsObjectOfClass(ctx: *mut JSContextRef, value: *mut JSValueRef, jsClass: *mut JSClassRef) -> bool;
    pub fn JSValueIsStrictEqual(ctx: *mut JSContextRef, a: *mut JSValueRef, b: *mut JSValueRef) -> bool;
    pub fn JSValueIsEqual(ctx: *mut JSContextRef, a: *mut JSValueRef, b: *mut JSValueRef, exception: *mut *mut JSValueRef) -> bool;
    pub fn JSValueToBoolean(ctx: *mut JSContextRef, value: *mut JSValueRef) -> bool;
    pub fn JSValueToNumber(ctx: *mut JSContextRef, value: *mut JSValueRef, exception: *mut *mut JSValueRef) -> c_double;
    pub fn JSValueToStringCopy(ctx: *mut JSContextRef, value: *mut JSValueRef, exception: *mut *mut JSValueRef) -> *mut JSStringRef;
    ...
    pub fn JSValueMakeSymbol(ctx: *mut JSContextRef, description: *mut JSStringRef) -> *mut JSValueRef;
}
...
unsafe extern "C" {
    ...
    pub fn JSObjectCallAsFunction(ctx: *mut JSContextRef, object: *mut JSObjectRef, thisObject: *mut JSObjectRef, argumentCount: usize, arguments: *const *mut JSValueRef, exception: *mut *mut JSValueRef) -> *mut JSValueRef;
    pub fn JSObjectCallAsConstructor(ctx: *mut JSContextRef, object: *mut JSObjectRef, argumentCount: usize, arguments: *const *mut JSValueRef, exception: *mut *mut JSValueRef) -> *mut JSObjectRef;
    pub fn JSObjectCopyProperty(ctx: *mut JSContextRef, object: *mut JSObjectRef, propertyName: *mut JSStringRef, exception: *mut *mut JSValueRef) -> *mut JSValueRef;
    pub fn JSObjectSetProperty(ctx: *mut JSContextRef, object: *mut JSObjectRef, propertyName: *mut JSStringRef, value: *mut JSValueRef, attributes: JSPropertyAttributes, exception: *mut *mut JSValueRef);
    pub fn JSObjectHasProperty(ctx: *mut JSContextRef, object: *mut JSObjectRef, propertyName: *mut JSStringRef) -> bool;
    pub fn JSObjectDeleteProperty(ctx: *mut JSContextRef, object: *mut JSObjectRef, propertyName: *mut JSStringRef, exception: *mut *mut JSValueRef) -> bool;
    pub fn JSObjectGetPrototype(ctx: *mut JSContextRef, object: *mut JSObjectRef) -> *mut JSValueRef;
    pub fn JSObjectSetPrototype(ctx: *mut JSContextRef, object: *mut JSObjectRef, value: *mut JSValueRef);
}
...
unsafe extern "C" {
    ...
    pub fn JSStringGetUTF8CString(string: *mut JSStringRef, buffer: *mut c_char, bufferSize: usize) -> usize;
...
unsafe extern "C" {
    pub fn JSEvaluateScript(ctx: *mut JSContextRef, script: *mut JSStringRef, thisObject: *mut JSObjectRef, sourceURL: *mut JSStringRef, startingLineNumber: i32, exception: *mut *mut JSValueRef) -> *mut JSValueRef;
}

// ── Typed Array functions ─────────────────────────────────────────────────

unsafe extern "C" {
    pub fn JSObjectMakeArrayBufferWithBytesNoCopy(ctx: *mut JSContextRef, bytes: *mut c_void, byteLength: usize, bytesDeallocator: *mut c_void, exception: *mut *mut JSValueRef) -> *mut JSObjectRef;
}
