...
- Keep `content/src/boa/bindings` thin: argument conversion and [inherited interfaces](https://webidl.spec.whatwg.org/#dfn-inherited-interfaces) checks live there, while stateful algorithms live on the owning [platform object](https://webidl.spec.whatwg.org/#dfn-platform-object) type.