...
- Use the `web_standards` extension (`spec_section`, `spec_algorithm`) with `https://streams.spec.whatwg.org/` to read the Streams spec, and `vendor/wpt/streams` as the test reference.