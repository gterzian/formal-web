...
//! handed to global scopes, and the map of active window timers whose earliest
//! deadline the content main loop waits on.
...
impl MapOfActiveTimers {
    ...
    /// <https://html.spec.whatwg.org/#run-steps-after-a-timeout>
    fn remove_active_timer(&mut self, timer_key: WindowTimerKey) {
