...
use crate::webidl::data_clone_error_value;
...
pub(crate) fn transfer_receiving_steps(
    ...
    // StructuredDeserializeWithTransfer step 3.2's OffscreenCanvas branch: a
    // new OffscreenCanvas is created in the target realm with the carried
