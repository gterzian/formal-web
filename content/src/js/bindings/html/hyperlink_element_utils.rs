...
use crate::js::{self, platform_objects};
...
fn link_property(
    ...
    name: &str,
    getter: fn(&JsValue, &[JsValue], &mut dyn ExecutionContext<BoaTypes>) -> Completion<JsValue, BoaTypes>,
    setter: Option<fn(&JsValue, &[JsValue], &mut dyn ExecutionContext<BoaTypes>) -> Completion<JsValue, BoaTypes>>,
) -> JsResult<()> {
...
fn ec_fn_ptr_to_js_function(
    f: fn(&JsValue, &[JsValue], &mut dyn ExecutionContext<BoaTypes>) -> Completion<JsValue, BoaTypes>,
    realm: &boa_engine::realm::Realm,
) -> JsObject {
...
fn get_username(this: &JsValue, _: &[JsValue], ec: &mut dyn ExecutionContext<BoaTypes>) -> Completion<JsValue, BoaTypes> {
    let value_undefined = ec.value_undefined();
    let ctx = unsafe { crate::js::ec_to_ctx(ec) };
    (|| -> JsResult<JsValue> {
    let document_creation_url = document_creation_url(ctx)?;
...
fn set_username(this: &JsValue, args: &[JsValue], ec: &mut dyn ExecutionContext<BoaTypes>) -> Completion<JsValue, BoaTypes> {
    let value_undefined = ec.value_undefined();
    let ctx = unsafe { crate::js::ec_to_ctx(ec) };
    (|| -> JsResult<JsValue> {
    let document_creation_url = document_creation_url(ctx)?;
...
fn get_password(this: &JsValue, _: &[JsValue], ec: &mut dyn ExecutionContext<BoaTypes>) -> Completion<JsValue, BoaTypes> {
    let value_undefined = ec.value_undefined();
    let ctx = unsafe { crate::js::ec_to_ctx(ec) };
    (|| -> JsResult<JsValue> {
    let document_creation_url = document_creation_url(ctx)?;
...
fn set_password(this: &JsValue, args: &[JsValue], ec: &mut dyn ExecutionContext<BoaTypes>) -> Completion<JsValue, BoaTypes> {
    let value_undefined = ec.value_undefined();
    let ctx = unsafe { crate::js::ec_to_ctx(ec) };
    (|| -> JsResult<JsValue> {
    let document_creation_url = document_creation_url(ctx)?;
