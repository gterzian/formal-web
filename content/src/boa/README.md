...
`content/src/boa` integrates Boa with the content process and keeps JavaScript-facing wrapper identity separate from DOM and HTML [platform object](https://webidl.spec.whatwg.org/#dfn-platform-object) state.
...
- `content/src/boa/bindings` should convert arguments, check [inherited interfaces](https://webidl.spec.whatwg.org/#dfn-inherited-interfaces) to identify the platform object's type, and delegate; stateful algorithms belong on the owning DOM, HTML, or Streams platform object type.
