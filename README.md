...
platform specific performance (like integrating with Core Animation based compositing on Mac), or simply to reduce binary size and build time by re-using what is already on the system.
